...
function Booking() {
    return (
        <div className='booking_bg w-screen '>
            <Navbar />
            <h1>Booking</h1>
            <div className="flex justify-evenly mt-10 h-[91vh]">
                <div className='shadow-lg shadow-black/20 '>
                    <form className="w-full max-w-lg m-10 bg-black/20 backdrop-blur-[1px]" >
                        <div className="flex flex-wrap justify-between -mx-3 mb-6 m-10" >
                ...
                <div>
                    {/* PRicing List */}
                    <div className="bg-black/20 w-[28vw]  shadow overflow-hidden backdrop-blur-[1px] sm:rounded-lg">
